<template>
    <div class="miaohu-template">
        ...
        <div class="group_input">
            ...
            <captcha-component :captchaError="registerMsg.msg.imageCaptcha" @click.native="errorHide('Captcha')" ref="register-Captcha" ></captcha-component>
        ...
        <p class="agreement-tip">点击「注册」按钮，即代表你同意<a href="/#" target="_blank">《知乎协议》</a></p>
    </div>
    <div v-show="choiceType ==='login'" class="miaohu-loginContent">
        <div class="group_input" v-if="loginType==='Pc'">
            ...
            <captcha-component :captchaError="registerMsg.msg.imageCaptcha" @click.native="errorHide('Captcha')" ref="login-Captcha"></captcha-component>
        </div>
        ...
        methods: {
            ...
            login() {
                ...
                this.$ajax({
                    ...
                    res.data.code == 200 ? location.href = '/signin.html' : flase
                })
            },
            getCaptcha(type) {
